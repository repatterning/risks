...
class Illustrate:
    ...
    def exc(self, points: int, n_catchments_visible: int):
        ...
        for parcel in self.__parcels:
            ...
            lower = instances['latest'].min()
            upper = instances['latest'].max()
            ...
            folium.GeoJson(
                ...
                marker=folium.CircleMarker(
                    radius=22.5, weight=2, color=colours(parcel.decimal), fillColor=colours(parcel.decimal), fill_opacity=0.65),
                ...
                style_function=lambda feature: {
                    "fillOpacity": custom.f_opacity(feature['properties']['latest'], lower=lower, upper=upper),
                    "opacity": custom.f_opacity(feature['properties']['latest'], lower=lower, upper=upper),
                    "radius": custom.f_radius(feature['properties']['latest'], lower=lower, upper=upper),
